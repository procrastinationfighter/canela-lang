...
module CanelaInterpreter where
...
data Value = Int Integer | Str String | Bool Bool | UserType [Value] | Fun Type [Type]
  deriving (Eq, Ord, Show, Read)
type Loc = Integer
type State = Map.Map Loc Value

type Var = (AbsCanela.AccessType, Loc)
type VarEnv = Map.Map Ident Var

type EnumVariant = (Ident, [AbsCanela.Type])
type EnumEnv = Map.Map Ident [EnumVariant]
